...
def inv_mix_single_column(col):
    ...
    col[0] = multiply(0x0e, a[0]) ^ multiply(0x0b, a[1]) ^ multiply(0x0d, a[2]) ^ multiply(0x09, a[3])
    col[1] = multiply(0x09, a[0]) ^ multiply(0x0e, a[1]) ^ multiply(0x0b, a[2]) ^ multiply(0x0d, a[3])
    col[2] = multiply(0x0d, a[0]) ^ multiply(0x09, a[1]) ^ multiply(0x0e, a[2]) ^ multiply(0x0b, a[3])
    col[3] = multiply(0x0b, a[0]) ^ multiply(0x0d, a[1]) ^ multiply(0x09, a[2]) ^ multiply(0x0e, a[3])
    return col
